...
namespace ETrade.Uw
{
    ...
    {
        TradeContext _db;
        public Uow(TradeContext db,IBasketDetailRep basketDetailRep, IBasketMasterRep basketMasterRep, ICategoriesRep categoriesRep, ICityRep cityRep, ICountyRep countyRep, 
            IProductsRep productsRep, ISuppliersRep suppliersRep, IUnitRep unitRep, IUsersRep usersRep,IVatRep vatRep )
        {
            _db = db;
